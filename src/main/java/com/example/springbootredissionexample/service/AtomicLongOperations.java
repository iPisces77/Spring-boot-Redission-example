...
/**
 * @ClassName AtomicLongOpertions.java @Description 原子整长型操作
 */
@Slf4j
@Component
public class AtomicLongOperations {
  ...
  public AtomicLongOperations(
      RedissonClient redissonClient) {
    this.redissonClient = redissonClient;
  }

  public void atomicLongOper() {
    RAtomicLong atomicLongOper = redissonClient.getAtomicLong("AtomicLongOperations");
    // 添加一个从0开始的元素
